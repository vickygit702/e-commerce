...
const ContactInfo = () => {
  return (
    <div className="flex flex-col gap-4 w-1/2 text-center justify-center">
      {/* Website name */}
      <h1 className="xl:text-xl  lg:text-lg md:text-md font-bold text-gray-800 text-center">
        eMart
      </h1>
      ...
      <div>
        ...
        <ul className="space-y-2 text-gray-600">
          <li className="xl:text-[16px]  lg:text-[14px] md:text-[12px] sm:text-[10px] flex items-center justify-center gap-2">
